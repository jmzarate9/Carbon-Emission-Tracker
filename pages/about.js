            ...
            <div className={aboutStyles.outerContainer}>
                <div className={aboutStyles.innerContainer}>
                    <div  className={aboutStyles.content}>
                        ...
                        <p className={aboutStyles.paragraph}>
                        I'm excited to mention the contribution of <a href='https://www.carboninterface.com/' target="_blank" rel="noopener noreferrer">Carbon Interface</a> and their API, which significantly aids in collecting precise carbon emissions data for our platform. Thanks to their technology, we're able to offer you valuable insights into your environmental impact.
                        </p>
                        <p className={aboutStyles.paragraph}>
